 ...
 * @author colin
 */
public class ModalAppointmentCreateView extends ModalView implements ActionListener {
    ...
    private final String CREATE_CAPTIOM = "<html?<center>Create</center><center>appointment</center></html>";
     ...
     * @param desktopView 
     */
    public ModalAppointmentCreateView(View.Viewer myViewType, 
    ...
    private boolean doCreateUpdateAppointmentRequest(){
        ...
        return OKToSaveAppointment==JOptionPane.YES_OPTION;
    }
