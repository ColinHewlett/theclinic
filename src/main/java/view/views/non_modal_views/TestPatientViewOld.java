 ...
 * @author colin
 */
public class TestPatientViewOld extends View {
    ...
    private String getPatientTitle(){
        String value = "";
        if(TestPatientViewOld.TitleItem.Dr.ordinal()==this.cmbTitle.getSelectedIndex()){
            value = TestPatientViewOld.TitleItem.Dr.toString();
        }
        else if(TestPatientViewOld.TitleItem.Mr.ordinal()==this.cmbTitle.getSelectedIndex()){
            value = TestPatientViewOld.TitleItem.Mr.toString();
        }
        else if(TestPatientViewOld.TitleItem.Mrs.ordinal()==this.cmbTitle.getSelectedIndex()){
            value = TestPatientViewOld.TitleItem.Mrs.toString();
        }
        else if(TestPatientViewOld.TitleItem.Ms.ordinal()==this.cmbTitle.getSelectedIndex()){
            value = TestPatientViewOld.TitleItem.Ms.toString();
        }
        else if(TestPatientViewOld.TitleItem.Miss.ordinal()==this.cmbTitle.getSelectedIndex()){
            value = TestPatientViewOld.TitleItem.Miss.toString();
        }
    ...
    private void setPatientTitle(String title){
        if (title == null){
            ...
            Integer index = null;
            for(TestPatientViewOld.TitleItem ti: TestPatientViewOld.TitleItem.values()){
    ...
    private void setGender(String gender){
        if (gender == null) cmbGender.setSelectedIndex(-1);
            ...
            Integer index = null;
            for (TestPatientViewOld.GenderItem gi: TestPatientViewOld.GenderItem.values()){
    ...
    private boolean getIsGuardianAPatient(){
        boolean value = false;
        if(TestPatientViewOld.YesNoItem.Yes.ordinal()==this.cmbIsGuardianAPatient.getSelectedIndex()){
            value = true;
        }
        else if(TestPatientViewOld.YesNoItem.No.ordinal()==this.cmbIsGuardianAPatient.getSelectedIndex()){
            value = false;
        }
        return value;
    }
    private void setIsGuardianAPatient(boolean isGuardianAPatient){
        if (isGuardianAPatient){
            cmbIsGuardianAPatient.setSelectedItem(TestPatientViewOld.YesNoItem.Yes);
        }
        else{
            cmbIsGuardianAPatient.setSelectedItem(TestPatientViewOld.YesNoItem.No);
        }
    }
...
//<editor-fold defaultstate="Collapsed" desc="Menu event handlers">    
    ...
    //</editor-fold>
        ...
        cmbIsGuardianAPatient = new javax.swing.JComboBox<TestPatientViewOld.YesNoItem>();
        ...
        cmbIsGuardianAPatient.setModel(new javax.swing.DefaultComboBoxModel<TestPatientViewOld.YesNoItem>(TestPatientViewOld.YesNoItem.values()));
        ...
        cmbTitle.setModel(new javax.swing.DefaultComboBoxModel<>(TestPatientViewOld.TitleItem.values()));
        ...
        cmbGender.setModel(new javax.swing.DefaultComboBoxModel<>(TestPatientViewOld.GenderItem.values()));
    ...
    private javax.swing.JComboBox<TestPatientViewOld.GenderItem> cmbGender;
    private javax.swing.JComboBox<TestPatientViewOld.YesNoItem> cmbIsGuardianAPatient;
    private javax.swing.JComboBox<Patient> cmbPatientSelector;
    private javax.swing.JComboBox<model.Patient> cmbSelectGuardian;
    private javax.swing.JComboBox<TestPatientViewOld.TitleItem> cmbTitle;
    ...
    private void cmbIsGuardianAPatientActionPerformed(java.awt.event.ActionEvent evt) {                                                      
        if (this.cmbIsGuardianAPatient.getSelectedItem()!=null){
            switch ((TestPatientViewOld.YesNoItem)this.cmbIsGuardianAPatient.getSelectedItem()){
                case Yes:
    ...
    private void cmbTitleActionPerformed(java.awt.event.ActionEvent evt) {                                         
        if (this.cmbTitle.getSelectedItem() != null){
            if (this.cmbTitle.getSelectedItem().equals(TestPatientViewOld.TitleItem.Untitled)){
