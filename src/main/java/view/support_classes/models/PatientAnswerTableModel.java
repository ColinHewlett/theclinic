 ...
 * @author colin
 */
public class PatientAnswerTableModel extends DefaultTableModel {
    
    private ArrayList<QuestionWithState> questionWithStates = null;
    private enum COLUMN{Answer};
    private final Class[] columnClass = new Class[] {
        String.class};

    public PatientAnswerTableModel(){
                ...
                if (questionWithState == null){
                    ...
                    switch (column){
                        ...
                        case Question:
                            ...
                            break;*/
                        case Answer:
                            if (!questionWithState.getState()) result = "";
                            else result = answer; 
                    }
                    break;
                }
