...
import theclinic.model.entity.*;
import theclinic.model.non_entity.*;
...
public class DesktopViewController extends ViewController{
    ...
    private theclinic.controller.SystemDefinition systemDefinition;
    ...
    public DesktopViewController(String[] args){
        ...
        try{
            ...
            /**
             * construct a TemplateRenderer for use by the message transmission facility included in pms 
             */
            Path templateFolder = (Path)getDescriptor().getControllerDescription().getProperty(SystemDefinition.Properties.TEMPLATES_FOLDER);
            try{
                TemplateRenderer templateRenderer = new TemplateRenderer(templateFolder);
                getDescriptor().getControllerDescription().setProperty(SystemDefinition.Properties.TEMPLATE_RENDERER, templateRenderer);
            }catch(IOException ex){
                displayErrorMessage(ex.getMessage() + "\nRaised in DesktopViewController constructor", 
            ...
            String lookAndFeel = (String)getDescriptor().getControllerDescription().getProperty(theclinic.controller.SystemDefinition.Properties.LOOK_AND_FEEL);
            switch (lookAndFeel){
                case "Metal" ->
                ...
                theclinic.controller.SystemDefinition.setSystemExitCode(2);
