 ...
 */
package theclinic.view;


/*import view.views.modal_views.ModalPatientMedicalHistory1EditorView;*/
import theclinic.view.views.dialog_views.DialogView;
import theclinic.view.views.dialog_views.DialogUsingGenericSelector;
import theclinic.view.views.non_modal_views.ProgressMonitorView;
import theclinic.view.views.non_modal_views.PatientDocumentStoreView;
import theclinic.view.views.non_modal_views.LoginNewPasswordEditorView;
import theclinic.view.views.non_modal_views.LoginOldPasswordCheckView;
import theclinic.view.views.non_modal_views.UserLoginView;
import theclinic.view.views.non_modal_views.DesktopView;
import theclinic.view.views.non_modal_views.ImageViewer;
import theclinic.view.views.non_modal_views.ArchivedPatientsView;
import theclinic.view.views.non_modal_views.ModalClinicalNoteView;
import theclinic.view.views.non_modal_views.MedicalConditionView;
import theclinic.view.views.non_modal_views.PatientAppointmentDataView;
import theclinic.view.views.non_modal_views.PatientInvoiceView;
import theclinic.view.views.non_modal_views.PatientMedicalHistoryView;
import theclinic.view.views.non_modal_views.PatientQuestionnaireView2;
import theclinic.view.views.non_modal_views.PatientView;
import theclinic.view.views.non_modal_views.ProgressMonitorView;
import theclinic.view.views.non_modal_views.ScheduleView;
import theclinic.view.views.non_modal_views.ToDoView;
import theclinic.view.views.non_modal_views.TreatmentView;
import theclinic.view.views.modal_views.ModalDocumentSenderView;
import theclinic.view.views.modal_views.ModalView;
import theclinic.view.views.modal_views.UserSystemWideSettingsView;
import theclinic.view.views.modal_views.ModalUserScheduleListSettingsView;
import theclinic.view.views.modal_views.ModalEmptySlotScanConfigurationView;
import theclinic.view.views.modal_views.ModalAppointmentTreatmentView;
import theclinic.view.views.modal_views.ModalBookableSlotScannerView;
import theclinic.view.views.modal_views.ModalCheckBoxListView;
import theclinic.view.views.modal_views.ModalDateDialog;
import theclinic.view.views.modal_views.ModalNonSurgeryDayEditorView;
import theclinic.view.views.modal_views.ModalPatientDoctorEditorView;
import theclinic.view.views.modal_views.ModalPatientGBTRecallEditorView;
import theclinic.view.views.modal_views.ModalPatientGuardianEditorView;
import theclinic.view.views.modal_views.ModalPatientMedicationEditorView;
import theclinic.view.views.modal_views.ModalPatientPhoneEmailEditorView;
import theclinic.view.views.modal_views.ModalPatientRecallEditorView;
import theclinic.view.views.modal_views.ModalPatientSelectionView;
import theclinic.view.views.modal_views.ModalPatientSelectorView;
import theclinic.view.views.modal_views.ModalProgressView;
import theclinic.view.views.modal_views.ModalScheduleAndTreatmentEditorView;
import theclinic.view.views.modal_views.ModalSurgeryDaysEditorView;
import theclinic.view.views.modal_views.ModalToDoEditorView;
import theclinic.view.views.modal_views.ModalUnbookableAppointmentSlotEditorView;
import theclinic.view.views.modal_views.ModalUnbookableSlotScannerView;
...
import theclinic.view.interfaces.IView;
import theclinic.view.interfaces.IViewInternalFrameListener;
    ...
    public View make(
        ...
        switch(viewer){
            ...
            case RECALL_PATIENTS_VIEW:
                setView(makeView(new ModalDocumentSenderView(viewer, controller, desktopView)));
                break; 
