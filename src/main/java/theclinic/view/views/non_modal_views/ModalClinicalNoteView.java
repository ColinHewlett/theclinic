...
import theclinic.controller.ClinicalNoteViewController;
    ...
    public void actionPerformed(ActionEvent e){
        ...
        switch (Action.valueOf(e.getActionCommand())){
            ...
            case REQUEST_DELETE_NOTE:{
                clinicalNote = (ClinicalNote)getMyController().getDescriptor().
                                getControllerDescription().getProperty(SystemDefinition.Properties.CLINICAL_NOTE);
    ...
    public void propertyChange(PropertyChangeEvent e){
        ...
        switch (propertyName){
            case CLINICAL_NOTE_RECEIVED:
                setClinicalNote((ClinicalNote)getMyController().getDescriptor()
                        .getControllerDescription().getProperty(SystemDefinition.Properties.CLINICAL_NOTE));
                break;
