...
import theclinic.controller.TreatmentViewController;
...
import theclinic.view.support_classes.table_models.TreatmentTableModel;
...
public class TreatmentView extends View 
    ...
    public void tableChanged(TableModelEvent e){
        ...
        getMyController().getDescriptor().getViewDescription().setProperty(SystemDefinition.Properties.TREATMENT, treatment);
    ...
    private void populateTreatmentTable(){
        ...
        treatments = ((Treatment)getMyController().getDescriptor()
                .getControllerDescription().getProperty(SystemDefinition.Properties.TREATMENT)).get();
