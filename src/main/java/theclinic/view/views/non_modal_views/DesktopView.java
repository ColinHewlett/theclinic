...
import theclinic.model.non_entity.DatePickerInDialog;
...
import theclinic.model.non_entity.JarFileFinder;
...
public class DesktopView extends javax.swing.JFrame 
    ...
    private JMenuItem mniTemplates = null;
    private void doSystemMenus(){
        ...
        Path templatesFolder = (Path)getMyController().getDescriptor().getControllerDescription().getProperty(Properties.TEMPLATES_FOLDER);
        ...
        mniTemplates = new JMenuItem("Message templates folder: " + templatesFolder);
        this.mnuSystemInformation.add(mniDocumentStore);
        this.mnuSystemInformation.add(mniPrintFolder);
        this.mnuSystemInformation.add(mniTemplates);
