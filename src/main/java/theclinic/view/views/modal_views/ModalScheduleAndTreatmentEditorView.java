...
import theclinic.view.support_classes.table_renderers.SelectStartTimeLocalDateTimeRenderer;
...
import static theclinic.controller.ViewController.ViewMode.EMERGENCY;
import theclinic.model.non_entity.TreatmentWithState;
...
import theclinic.view.support_classes.AppointmentDateVetoPolicy;
import theclinic.view.support_classes.table_models.TreatmentWithStateTableModel;
 ...
 * @author colin
 */
public class ModalScheduleAndTreatmentEditorView extends ModalView
     ...
     * @param desktopView 
     */
    public ModalScheduleAndTreatmentEditorView(View.Viewer myViewType, 
    ...
    public void tableChanged(TableModelEvent e){
        ...
        if (e.getSource() instanceof TreatmentWithStateTableModel){
            ...
            if (treatmentWithState.getState())
                actionCommand = ScheduleViewController.Actions.TREATMENT_STATE_SET_REQUEST;
            else actionCommand = ScheduleViewController.Actions.TREATMENT_STATE_RESET_REQUEST;
            doSendActionEvent(actionCommand);*/
        }
    }
    
    private TreatmentWithState getSelectedTreatmentWithStateFromTable(){
        TreatmentWithState result = new TreatmentWithState();
        TreatmentWithState _tws = null;
        ArrayList<TreatmentWithState> tws = new ArrayList<>();
        TreatmentWithStateTableModel model = 
                (TreatmentWithStateTableModel)this.tblTreatmentWithState.getModel();
        for(int row = 0; row < model.getRowCount(); row++){
            _tws = (TreatmentWithState)model.getElementAt(row);
            if (_tws.getState()){
                tws.add(_tws);
            }
        }
    ...
    private void doCreateAppointmentRequest(){
        if (isOKToSendAppointmentRequest()){
            TreatmentWithState tws = getSelectedTreatmentWithStateFromTable();
            getMyController().getDescriptor().getViewDescription().
    ...
    public void initialiseView(){
        ...
        //this.setSize(this.getWidth(), getHeight());
    ...
    private void setAppointment(){
        ...
        appointment.setComment(txaBookingComment.getText());
    ...
    private void initComponents() {
        ...
        pnlBookingComment = new javax.swing.JPanel();
        jScrollPane1 = new javax.swing.JScrollPane();
        txaBookingComment = new javax.swing.JTextArea();
        pnlTreatmentSelection = new javax.swing.JPanel();
        ...
        pnlBookingDetails.setBorder(javax.swing.BorderFactory.createTitledBorder("Details of the booking"));
        ...
        pnlBookingComment.setBorder(javax.swing.BorderFactory.createTitledBorder("Comment added to this booking"));
        ...
        pnlBookingComment.setLayout(pnlBookingCommentLayout);
        pnlBookingCommentLayout.setHorizontalGroup(
            pnlBookingCommentLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, pnlBookingCommentLayout.createSequentialGroup()
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addComponent(jScrollPane1, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );
        pnlBookingCommentLayout.setVerticalGroup(
            pnlBookingCommentLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, pnlBookingCommentLayout.createSequentialGroup()
            ...
            .addGroup(pnlBookingDetailsLayout.createSequentialGroup()
                ...
                .addGroup(pnlBookingDetailsLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, pnlBookingDetailsLayout.createSequentialGroup()
                        .addGroup(pnlBookingDetailsLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addComponent(pnlBookingComment, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        pnlBookingDetailsLayout.setVerticalGroup(
            ...
            .addGroup(pnlBookingDetailsLayout.createSequentialGroup()
                ...
                .addComponent(pnlBookingComment, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );

        pnlTreatmentSelection.setBorder(javax.swing.BorderFactory.createTitledBorder("Select treatment(s)"));
        ...
        javax.swing.GroupLayout pnlTreatmentSelectionLayout = new javax.swing.GroupLayout(pnlTreatmentSelection);
        pnlTreatmentSelection.setLayout(pnlTreatmentSelectionLayout);
        pnlTreatmentSelectionLayout.setHorizontalGroup(
            pnlTreatmentSelectionLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(pnlTreatmentSelectionLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(scrTreatment, javax.swing.GroupLayout.DEFAULT_SIZE, 242, Short.MAX_VALUE)
                .addContainerGap())
        );
        pnlTreatmentSelectionLayout.setVerticalGroup(
            pnlTreatmentSelectionLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(pnlTreatmentSelectionLayout.createSequentialGroup()
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(pnlTreatmentSelection, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(12, 12, 12)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(pnlTreatmentSelection, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addGap(12, 12, 12))
        );
    ...
    private javax.swing.JPanel pnlBookingComment;
    ...
    private javax.swing.JPanel pnlTreatmentSelection;
    ...
    private javax.swing.JTextArea txaBookingComment;
