...
public class ModalSurgeryDaysEditorView extends ModalView {
    ...
    public void initialiseView(){
        ...
        HashMap<DayOfWeek, Boolean> surgeryDays = (HashMap<DayOfWeek, Boolean>)getMyController().
                getDescriptor().getControllerDescription().getProperty(SystemDefinition.Properties.SURGERY_DAYS_ASSIGNMENT);
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        getMyController().getDescriptor().getViewDescription().
                setProperty(SystemDefinition.Properties.SURGERY_DAYS_ASSIGNMENT, surgeryDaysAssignmentValue);
