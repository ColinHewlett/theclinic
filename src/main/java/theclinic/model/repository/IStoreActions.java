...
public interface IStoreActions {  
    ...
    public Point count(UserSettings userSettings)throws StoreException;
    
    //public void create(ArchivedPatient ap) throws StoreException;;
    ...
    //public void create(PatientAppointmentData pad) throws StoreException;;
    ...
    public void create(Transmission transmission)throws StoreException;
    ...
    public void create(UserSettings _userSettings)throws StoreException;
    ...
    public void delete(UserSettings userSettings)throws StoreException;
    ...
    public Integer insert(Question questionj)throws StoreException;
    ...
    public void insert(UserSettings userSettings)throws StoreException;
