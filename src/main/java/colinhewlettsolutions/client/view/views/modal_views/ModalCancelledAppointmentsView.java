...
import colinhewlettsolutions.client.view.support_classes.renderers.CancelledAppointmentsTablePatientRenderer;
...
*/
    ...
    private void populateCancelledAppointmentsTable(){
        ...
        Iterator<Appointment> it = 
                ((java.util.ArrayList<Appointment>)getMyController().getDescriptor().getControllerDescription().
                        getProperty(SystemDefinition.Properties.APPOINTMENT_CACELLATIONS)).iterator();
        while (it.hasNext()){
    ...
    private void btnUncancelSelectedAppointmentActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUncancelSelectedAppointmentActionPerformed
        ...
        if (row != -1){
            getMyController().getDescriptor().getViewDescription().
                    setProperty(SystemDefinition.Properties.APPOINTMENT,((CancelledAppointmentsTableModel)tblCancelledAppointments.
