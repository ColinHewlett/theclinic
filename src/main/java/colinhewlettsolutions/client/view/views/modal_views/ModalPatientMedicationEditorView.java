...
import colinhewlettsolutions.client.view.support_classes.models.MedicationTableModel;
...
public class ModalPatientMedicationEditorView extends ModalView 
    ...
    public void initialiseView(){
        ...
        Medication medication = (Medication)getMyController()
                .getDescriptor().getControllerDescription().getProperty(SystemDefinition.Properties.MEDICATION);
