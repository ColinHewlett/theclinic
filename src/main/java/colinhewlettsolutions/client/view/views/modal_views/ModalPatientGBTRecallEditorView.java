 ...
 * @author colin
 */
public class ModalPatientGBTRecallEditorView extends ModalView{
     ...
     * @param desktopView 
     */
    public ModalPatientGBTRecallEditorView(
    ...
    public void initialiseView(){
        initComponents();
        setTitle("Patient GBT recall editor");
        setVisible(true);
        ...
        setRecallDate(patient.getRecall().getGBTDate());
        setRecallFrequency(patient.getRecall().getGBTFrequency());
        setHasRecallDateChanged(false);
        setHasRecallFrequencyChanged(false);
        dpsRecallDatePicker.addDateChangeListener(
                new ModalPatientGBTRecallEditorView.
    ...
    private void doSaveEditorChanges(){
        ...
        if (getHasRecallDateChanged()){
            patient.getRecall().setGBTDate(getRecallDate());
            getMyController()
                    .getDescriptor()
                    .getViewDescription()
        ...
        if (getHasRecallFrequencyChanged()){
            patient.getRecall().setGBTFrequency(getRecallFrequency());
    ...
    private void initComponents() {
        ...
        this.spnRecallFrequency.setModel(new SpinnerNumberModel(0,0,12,1));
        ...
        btnCancel.addActionListener(new java.awt.event.ActionListener() {
            ...
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                doSaveEditorChanges();
                try{
                    ModalPatientGBTRecallEditorView.this.setClosed(true);   
