...
import colinhewlettsolutions.client.view.dialogs.CustomComboBoxDialog;
...
public class ScheduleDiaryView extends BookingView 
    ...
    public void initialiseView(){
        ...
        if ((Boolean)getMyController().getDescriptor().getControllerDescription().getProperty(Properties.LOGIN_REQUIRED)){
            ...
            mniColorPicker.setActionCommand(Action.REQUEST_USER_SCHEDULE_DIARY_COLOR_SETTINGS_VIEW.toString());
        ...
        this.vetoPolicy = new AppointmentDateVetoPolicy((HashMap<DayOfWeek,Boolean>)getMyController().
                getDescriptor().getControllerDescription().getProperty(Properties.SURGERY_DAYS_ASSIGNMENT));
        ...
        LocalDate day = (LocalDate)getMyController().getDescriptor().getControllerDescription().
                getProperty(Properties.SCHEDULE_DAY);
        if (!vetoPolicy.isDateAllowed(day)){
            /*switch(getMyController().
                    getDescriptor().
                    getControllerDescription().
                    getViewMode()){*/
            switch(getMyController().getDescriptor().getControllerDescription().
        ...
        Font testFont = (java.awt.Font)getMyController().getDescriptor().getControllerDescription().
                        getProperty(Properties.TITLED_BORDER_FONT);
        Color testColor = (java.awt.Color)getMyController().getDescriptor().getControllerDescription().
         ...
         * -- no; fetch default settings in controller on entry
         */
        ActionEvent actionEvent = null;
        if ((Boolean)getMyController().getDescriptor().getControllerDescription().getProperty(Properties.LOGIN_REQUIRED)){
            actionEvent = new ActionEvent(this, ActionEvent.ACTION_PERFORMED,
                    ViewController.ScheduleViewControllerActionEvent.USER_SCHEDULE_DIARY_SETTINGS_REQUEST.toString());
    ...
    public void actionPerformed(ActionEvent e){
        ...
        switch (actionCommand){
            case REQUEST_EARLY_BOOKING_START_TIME:
                ...
                appointment = (Appointment)((ArrayList<Appointment>)getMyController().getDescriptor().getControllerDescription()
                                .getProperty(Properties.APPOINTMENT_SLOTS_FOR_DAY_IN_LIST_FORMAT)).get(0);
                ...
                if (getDialogView().getSelectedItem()!=null){
                    getMyController().getDescriptor().getViewDescription()
                            .setProperty(Properties.EARLY_BOOKING_START_TIME, (LocalDateTime)getDialogView().getSelectedItem());
                    actionEvent = new ActionEvent(this, ActionEvent.ACTION_PERFORMED,
            ...
            case REQUEST_LATE_BOOKING_END_TIME:
                ...
                int count = ((ArrayList<Appointment>)getMyController().getDescriptor().getControllerDescription()
                                .getProperty(Properties.APPOINTMENT_SLOTS_FOR_DAY_IN_LIST_FORMAT)).size();
                appointment = (Appointment)((ArrayList<Appointment>)getMyController().getDescriptor().getControllerDescription()
                                .getProperty(Properties.APPOINTMENT_SLOTS_FOR_DAY_IN_LIST_FORMAT)).get(count-1);
                //if (appointment.getIsKeyDefined()){
                    ...
                    if (getDialogView().getSelectedItem()!=null){
                        getMyController().getDescriptor().getViewDescription()
                                .setProperty(Properties.LATE_BOOKING_END_TIME, (LocalDateTime)getDialogView().getSelectedItem());
                        actionEvent = new ActionEvent(this, ActionEvent.ACTION_PERFORMED,
            ...
            case REQUEST_UNBOOKABLE_SLOT_SCANNER_VIEW:
                ...
                getMyController().actionPerformed(actionEvent);
                break;
            case REQUEST_USER_SCHEDULE_DIARY_COLOR_SETTINGS_VIEW:
                actionEvent = new ActionEvent(
                        this,ActionEvent.ACTION_PERFORMED,
                        ViewController.ScheduleViewControllerActionEvent.
                                USER_SCHEDULE_DIARY_SETTINGS_EDITOR_VIEW_REQUEST.toString());
                getMyController().actionPerformed(actionEvent);
                break;
            ...
            case REQUEST_CREATE_APPOINTMENT:               
                ArrayList<Patient> patients = (ArrayList<Patient>)getMyController().getDescriptor().
                        getControllerDescription().getProperty(Properties.PATIENTS);
            ...
            case REQUEST_MOVE_BOOKING:
                getMyController().getDescriptor().getViewDescription()
                        .setProperty(Properties.APPOINTMENT, getSelectedAppointmentFromDiary());
    ...
    public void dateChanged(DateChangeEvent e){
        getMyController().getDescriptor().getViewDescription().setProperty(Properties.SCHEDULE_DAY, this.dayDatePicker.getDate());
            clearSelectionFromScheduleTable();
        ...
        if (e.getSource() instanceof DesktopViewController){
            ...
            switch (propertyName){
                ...
                case APPOINTMENT_SCHEDULE_ERROR_RECEIVED ->{
                    if (e.getSource() instanceof DesktopViewController){
                        String message = (String)getMyController().getDescriptor().getControllerDescription().getProperty(Properties.ERROR);
    ...
    private void doPrintScheduleRequest(){
        getMyController().getDescriptor().getViewDescription().setProperty(Properties.SCHEDULE_DAY, dayDatePicker.getDate());
    ...
    private void configureScheduleDiaryView(){
        ...
        this.tblScheduleMorning.setDefaultRenderer(LocalDateTime.class, new ScheduleDiaryTableLocalDateTimeRenderer(this));
        this.tblScheduleMorning.setDefaultRenderer(Patient.class, new ScheduleDiaryTablePatientRenderer(this));
        tblScheduleMorning.getColumnModel().getColumn(2).setCellRenderer(new ScheduleDiaryTableStringRenderer(this));
        ...
        this.tblScheduleAfternoon.setDefaultRenderer(LocalDateTime.class, new ScheduleDiaryTableLocalDateTimeRenderer(this));
        this.tblScheduleAfternoon.setDefaultRenderer(Patient.class, new ScheduleDiaryTablePatientRenderer(this));
        tblScheduleAfternoon.getColumnModel().getColumn(2).setCellRenderer(new ScheduleDiaryTableStringRenderer(this));
        ...
        this.tblScheduleEvening.setDefaultRenderer(LocalDateTime.class, new ScheduleDiaryTableLocalDateTimeRenderer(this));
        this.tblScheduleEvening.setDefaultRenderer(Patient.class, new ScheduleDiaryTablePatientRenderer(this));
        tblScheduleEvening.getColumnModel().getColumn(2).setCellRenderer(new ScheduleDiaryTableStringRenderer(this));
    ...
    private void setScheduleSlotData(){
        ...
        ArrayList<Slot> schedule = (ArrayList<Slot>)getMyController().getDescriptor()
                        .getControllerDescription().getProperty(Properties.APPOINTMENT_SLOTS_FOR_DAY_IN_DIARY_FORMAT);
    ...
    private void populateSchedule(){
        ...
        this.clearSelectionFromScheduleTable();
        setTitle(((LocalDate)getMyController().getDescriptor().getControllerDescription().getProperty(Properties.SCHEDULE_DAY)).
    ...
    private Appointment getViewDescriptorAppointment(){
        return (Appointment)getMyController().getDescriptor().getViewDescription().getProperty(Properties.APPOINTMENT);
    }
    ...
    private void doClinicNoteRequest(Slot slot){
        ...
        if (appointment!=null){
            getMyController().getDescriptor().getViewDescription()
                    .setProperty(Properties.APPOINTMENT, appointment);
    ...
    private void doClinicalNoteRequest(){
        Appointment appointment = (Appointment)getMyController().getDescriptor()
                .getViewDescription().getProperty(Properties.APPOINTMENT);
        if (appointment!=null){
            if(!appointment.getIsKeyDefined()){
                appointment  = null;
            }else if(appointment.getIsUnbookableSlot()){
    ...
    */
    ...
    private void setScheduleSettings(){
        for( var setting : SystemDefinition.UserScheduleDiarySettings.values()){
            SystemDefinition.Properties property = SystemDefinition.Properties.valueOf(setting.toString());
            switch(property){
                case DIARY_BOOKABLE_SLOT_BACKGROUND ->{
                    break;
                }
                case DIARY_BOOKABLE_SLOT_FOREGROUND ->{
                    break;
                }
                case DIARY_BOOKING_FIRST_SLOT_BACKGROUND ->{
                    break;
                }
                case DIARY_BOOKING_FIRST_SLOT_FOREGROUND ->{
                    break;
                }
                case DIARY_BOOKING_REMAINING_SLOTS_BACKGROUND ->{
                    break;
                }
                case DIARY_BOOKING_REMAINING_SLOTS_FOREGROUND ->{
                    break;
                }
                case DIARY_EMERGENCY_BOOKING_SLOT_BACKGROUND ->{
                    break;
                }
                case DIARY_EMERGENCY_BOOKING_SLOT_FOREGROUND ->{
                    break;
                }
                case DIARY_UNBOOKABLE_SLOT_BACKGROUND ->{
                    break;
                }
                case DIARY_UNBOOKABLE_SLOT_FOREGROUND ->{
                    break;
                }
            }
        }
    ...
    private void setScheduleTitledBorderSettings(){
        ...
        setBorderTitles(BorderTitles.SCHEDULE_TABLES);
        setBorderTitles(BorderTitles.SLOT_SCANNER);
        setBorderTitles(BorderTitles.UNDO_SELECTION);
    ...
    private void setBorderTitles(BorderTitles borderTitles){
        ...
        if (panel!=null){
            ...
            String message = "Unexpected null value for titled border panel encountered in ScheduleDiaryView::setBorderTitles() method";
    ...
    */
    ...
    enum Action{
        ...
        REQUEST_USER_SCHEDULE_DIARY_COLOR_SETTINGS_VIEW,
