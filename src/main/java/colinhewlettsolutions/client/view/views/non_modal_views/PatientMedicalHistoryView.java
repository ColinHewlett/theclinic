...
import colinhewlettsolutions.client.view.support_classes.models.MedicalConditionWithStateTableModel;
...
public class PatientMedicalHistoryView extends View 
        ...
        switch (propertyName){
            case CONDITION_WITH_STATE_RECEIVED:
                ConditionWithState cws = (ConditionWithState)getMyController().getDescriptor()
                        .getControllerDescription().getProperty(SystemDefinition.Properties.CONDITION_WITH_STATE);
    ...
    private void setConditionWithState(ConditionWithState cws){
        getMyController().getDescriptor()
                .getViewDescription().setProperty(SystemDefinition.Properties.CONDITION_WITH_STATE, cws);
    }
    private ConditionWithState getConditionWithState(){
        return (ConditionWithState)getMyController().getDescriptor()
                .getControllerDescription().getProperty(SystemDefinition.Properties.CONDITION_WITH_STATE);
    }
    ...
    private PatientCondition getPatientCondition(){
        return (PatientCondition)getMyController().getDescriptor()
                .getControllerDescription().getProperty(SystemDefinition.Properties.PATIENT_CONDITION);
    }
    private void setPatientCondition(PatientCondition value){
        getMyController().getDescriptor()
                .getViewDescription().setProperty(SystemDefinition.Properties.PATIENT_CONDITION, value);
    }
    
    private Patient patient = null;
    private Patient getPatient(){
        return (Patient)getMyController().getDescriptor()
                .getControllerDescription().getProperty(SystemDefinition.Properties.PATIENT);
    }
    private void setPatient(Patient value){
        getMyController().getDescriptor()
                .getViewDescription().setProperty(SystemDefinition.Properties.PATIENT, value);
    }
