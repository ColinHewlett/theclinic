...
import colinhewlettsolutions.client.view.support_classes.models.NotificationView4ColumnTableModel;
...
import colinhewlettsolutions.client.model.entity.Notification;import java.awt.Container;
        ...
        switch (propertyName){
            case RECEIVED_PATIENT_NOTIFICATIONS:
                populatePatientNotificationTable(
                        (ArrayList<Notification>)getMyController().
                                getDescriptor().getControllerDescription().getProperty(SystemDefinition.Properties.PATIENT_NOTIFICATIONS),false);
                setTitle(getUITitle());
               ...
               case RECEIVED_UNACTIONED_NOTIFICATIONS:
                populatePatientNotificationTable(
                        (ArrayList<Notification>)getMyController().
                                getDescriptor().getControllerDescription().getProperty(SystemDefinition.Properties.PATIENT_NOTIFICATIONS),true);
                setTitle(getUITitle());
                this.tblNotifications.clearSelection();
 ...
 -- an ArrayList<PatientNotification> is included in the EntityDescription::setPatientNotifications() method which identifies the selected notifications
    ...
    private void btnActionSelectedNotificationsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnActionSelectedNotificationsActionPerformed
        ...
        if (!isError){
            ...
            getMyController().getDescriptor().getViewDescription().setProperty(SystemDefinition.Properties.PATIENT_NOTIFICATIONS, patientNotifications);
            ActionEvent actionEvent = new ActionEvent(
                this,ActionEvent.ACTION_PERFORMED,
    ...
    private void btnEditSelectedNotificationActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditSelectedNotificationActionPerformed
        ...
        if (!isError){
            ...
            getMyController().getDescriptor().getViewDescription().
                    setProperty(SystemDefinition.Properties.PATIENT_NOTIFICATION, model.getElementAt(this.tblNotifications.getSelectedRow()));
            ActionEvent actionEvent = new ActionEvent(
                    this,ActionEvent.ACTION_PERFORMED,
        ...
        if (!isError){
            ...
            if (reply==JOptionPane.YES_OPTION){
                ...
                NotificationView4ColumnTableModel model = 
                    (NotificationView4ColumnTableModel)this.tblNotifications.getModel();
                getMyController().getDescriptor().getViewDescription().
                        setProperty(SystemDefinition.Properties.PATIENT_NOTIFICATION, model.getElementAt(row));
                ActionEvent actionEvent = new ActionEvent(
                    this,ActionEvent.ACTION_PERFORMED,
                    ViewController.NotificationViewControllerActionEvent.
