...
import colinhewlettsolutions.client.model.non_entity.ID;
...
public class SystemDefinition {
    ...
    public static String userS;
     ...
     public static Integer systemExitCode = 0; 
    public static void setSystemExitCode(Integer value){
        systemExitCode = value;
    }
    public static Integer getSystemExitCode(){
        ...
        try{
            switch(propertyCategory) {
                case USER_SCHEDULE_DIARY_SETTINGS,
                    ...
                    user = (User)viewController.getDescriptor().getControllerDescription().getProperty(Properties.USER);
                    userSettings = new UserSettings(user);
                    userSettings.setScope(Entity.Scope.valueOf(propertyCategory.toString()));
                    userSettings.read();
                    break;
                }
                default ->{
                    String message = "Unexpected property category (" + 
                            propertyCategory.toString() + ") encountered in method SystemDefinition::getSettingsFor() method"; 
                    JOptionPane.showMessageDialog(view, message, "Controller error", JOptionPane.WARNING_MESSAGE);
                    break;
                }
            }
        }catch(StoreException ex){
            String message = ex.getMessage() + "\n";
            message = message + "StoreException handled in SystemDefinition::getSettingsFor("
                    + "View = " + view.getTitle() + ", property category = " + propertyCategory.toString() + ")";
            displayErrorMessage(message, "Controller error", JOptionPane.WARNING_MESSAGE);
        }
    }
    
    public static String systemExitMessage = "";
    public static String getSystemExitMessage(){
        return systemExitMessage;
    }
    public static void setSystemExitMessage(String value){
        systemExitMessage = value;
    }
...
//</editor-fold>
    ...
    public enum UserScheduleDiarySettings{
        DIARY_BOOKING_FIRST_SLOT_BACKGROUND,
        DIARY_BOOKING_FIRST_SLOT_FOREGROUND,
        DIARY_BOOKING_REMAINING_SLOTS_BACKGROUND,
        DIARY_BOOKING_REMAINING_SLOTS_FOREGROUND,
        DIARY_BOOKABLE_SLOT_BACKGROUND,
        DIARY_BOOKABLE_SLOT_FOREGROUND,
        DIARY_EMERGENCY_BOOKING_SLOT_BACKGROUND,
        DIARY_EMERGENCY_BOOKING_SLOT_FOREGROUND,
        DIARY_UNBOOKABLE_SLOT_BACKGROUND,
        DIARY_UNBOOKABLE_SLOT_FOREGROUND
    }
    
    public enum UserScheduleListSettings{
        LIST_BOOKABLE_SLOT_BACKGROUND,
        LIST_BOOKABLE_SLOT_FOREGROUND,
        LIST_EMERGENCY_BOOKING_BACKGROUND,
        LIST_EMERGENCY_BOOKING_FOREGROUND,
        LIST_UNBOOKABLE_SLOT_BACKGROUND,
        LIST_UNBOOKABLE_SLOT_FOREGROUND
    }
    
    public enum UserSystemWideSettings{
        TITLED_BORDER_COLOR,
        TITLED_BORDER_FONT
    }
    ...
    public enum Properties{
        ...
        APPOINTEE_REMINDERS_COUNT_FOR_DAY,
        APPOINTMENT,
        APPOINTMENT_CACELLATIONS,
        APPOINTMENT_EARLY_START,
        APPOINTMENT_LATE_START,
        APPOINTMENT_SLOTS,
        ...
        EMPTY_SLOT_FROM_DAY,
        EMPTY_SLOT_MINIMUM_DURATION,
        INVOICE,
        IS_APPOINTMENT_UNBOOKABLE,
        ITEM_COUNTER,
        LATE_BOOKING_END_TIME,
        LIST_BOOKABLE_SLOT_BACKGROUND,
        LIST_BOOKABLE_SLOT_FOREGROUND,
        LIST_EMERGENCY_BOOKING_BACKGROUND,
        LIST_EMERGENCY_BOOKING_FOREGROUND,
    ...
    public enum ViewControllers{
        ARCHIVED_PATIENTS_VIEW_CONTROLLER,
        CLINICAL_NOTE_VIEW_CONTROLLER,
        LOGIN_VIEW_CONTROLLER,
        MEDICAL_CONDITION_VIEW_CONTROLLER,
        NOTIFICATION_VIEW_CONTROLLER,
        PATIENT_APPOINTMENYT_DATA_VIEW_CONTROLLER,
        PATIENT_INVOICE_VIEW_CONTROLLER,
        PATIENT_MEDICAL_HISTORY_VIEW_CONTROLLER,
        PATIENT_QUESTIONNAIRE_VIEW_CONTROLLER,
        PATIENT_VIEW_CONTROLLER,
        SCHEDULE_VIEW_CONTROLLER,
        TO_DO_VIEW_CONTROLLER,
        TREATMENT_VIEW_CONTROLLER
    }
    
    public enum ARCHIVED_PATIENTS_VIEW_CONTROLLER_VIEWS{
        
    }
    
    public enum CLINICAL_NOTE_VIEW_CONTROLLER_VIEWS{
        
    }
    
    public enum LOGIN_VIEW_CONTROLLER_VIEWS{
        
    }
    
    public enum MEDICAL_CONDITION_VIEW_CONTROLLER_VIEWS{
        
    }
    
    public enum NOTIFICATION_VIEW_CONTROLLER_VIEWS{
        
    }
    
    public enum PATIENT_APPOINTMENYT_DATA_VIEW_CONTROLLER_VIEWS{
        
    }
    
    public enum PATIENT_INVOICE_VIEW_CONTROLLER_VIEWS{
        
    }
    
    public enum PATIENT_MEDICAL_HISTORY_VIEW_CONTROLLER_VIEWS{
        
    }
    
    public enum PATIENT_QUESTIONNAIRE_VIEW_CONTROLLER_VIEWS{
        
    }
    
    public enum PATIENT_VIEW_CONTROLLER_VIEWS{
        
    }
    
    public enum SCHEDULE_VIEW_CONTROLLER_VIEWS{
        
    }
    
    public enum TO_DO_VIEW_CONTROLLER_VIEWS{
        
    }
    
    public enum TREATMENT_VIEW_CONTROLLER_VIEWS{
