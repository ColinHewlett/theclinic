...
public class NotificationViewController extends ViewController{
    ...
    private void doNotificationsForPatientRequest()throws StoreException{
        ...
        getDescriptor().getControllerDescription()
                .setProperty(SystemDefinition.Properties.PATIENT_NOTIFICATION, notification.get());
...
*/
    private void doActionPatientNotificationRequest(){
         ...
         */
        Notification notification = (Notification)getDescriptor().getViewDescription().getProperty(SystemDefinition.Properties.PATIENT_NOTIFICATION);
        try{
            notification.update();
            doUnactionedPatientNotificationsRequest();
        }catch (StoreException ex){
 ...
 -- 
    ...
    private void doCreatePatientNotificationRequest(){
        ...
        setDescriptor(new Descriptor());
        getDescriptor().getControllerDescription().setProperty(SystemDefinition.Properties.PATIENT_NOTIFICATIONS, new ArrayList<>());
    ...
    private void doUpdatePatientNotificationRequest(){
        ...
        //setOldEntityDescriptor(getDescriptor());
        //setDescriptor(new Descriptor());
        getDescriptor().getControllerDescription().setProperty(SystemDefinition.Properties.PATIENT_NOTIFICATION, notification);
        try{
            /**
            ...
            getDescriptor().getControllerDescription()
                    .setProperty(SystemDefinition.Properties.PATIENT_NOTIFICATIONS, patientNotification.get());
            getDescriptor().getControllerDescription().
    ...
    private void doPatientNotificationEditorCreateNotificationRequest()throws StoreException{
        Notification patientNotification = 
                (Notification)getDescriptor().getViewDescription().getProperty(SystemDefinition.Properties.PATIENT_NOTIFICATION);
    ...
    private void sendPrimaryViewPatientNotifications(Notification.Scope scope)throws StoreException{
        ...
        patientNotification.read();
        getDescriptor().getControllerDescription().setProperty(SystemDefinition.Properties.PATIENT_NOTIFICATIONS, patientNotification.get());
        String pcEventName;
